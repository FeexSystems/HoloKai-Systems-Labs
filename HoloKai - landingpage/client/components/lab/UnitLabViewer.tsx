          ...
          <div className="pointer-events-auto flex items-center gap-2">
            ...
            {onOpenSplineLab && (
              <button
                ...
                className="flex items-center gap-1.5 border border-white/15 bg-black/55 px-4 py-2.5 text-[10px] font-bold tracking-[0.18em] text-zinc-300 backdrop-blur-xl transition hover:border-amber-500/40 hover:text-white"
