...
export const metadata = {
  title: 'HoloKai Oracle · AI Research Synthesis',
  description: 'Oracle AI research synthesis, epigraphy & reasoning engine. Multi-agent epistemic classification for Pan-African history.',
  openGraph: {
    title: 'HoloKai Oracle · AI Research Synthesis',
    description: 'Oracle AI research synthesis, epigraphy & reasoning engine with multi-agent epistemic classification.',
