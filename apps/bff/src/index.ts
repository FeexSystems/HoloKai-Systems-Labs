...
const envSchema = z.object({
  ...
  // Note: Firebase credentials are often handled implicitly via GOOGLE_APPLICATION_CREDENTIALS,
  // but we enforce DATABASE_URL because the drizzle ORM strictly requires it.
});
