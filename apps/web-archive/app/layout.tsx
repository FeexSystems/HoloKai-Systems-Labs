...
export const metadata = {
  title: 'HoloKai Archive · 16-Volume Codex',
  description: '16-volume historical knowledge corpus, manuscripts, and 3D gallery. Pan-African epigraphy, astronomy, and oral tradition preserved.',
  openGraph: {
    title: 'HoloKai Archive · 16-Volume Codex',
    description: '16-volume historical knowledge corpus, manuscripts, and 3D gallery preserving Pan-African history.',
