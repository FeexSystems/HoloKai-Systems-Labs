...
const DEFAULT_SPLINE_URL = (import.meta.env.VITE_SPLINE_SCENE_URL || 'https://prod.spline.design/UxqPsHJtrHQardbV/scene.splinecode').trim();
...
export const ARTIFACT_COLLECTION = [
  {
    ...
    interactiveProps: { rotationSpeed: 0.8, wireframe: false, glowColor: '#f59e0b' }
  },
  {
    id: 'art-kush-2',
    civId: 'kush',
  ...
  },
  {
    ...
    interactiveProps: { rotationSpeed: 1.0, wireframe: false, glowColor: '#f59e0b' }
  },
  {
    id: 'art-mali-1',
    civId: 'mali',
  ...
  },
  {
    ...
    interactiveProps: { rotationSpeed: 0.5, wireframe: false, glowColor: '#f59e0b' }
  },
  {
    id: 'art-zimbabwe-1',
    civId: 'zimbabwe',
  ...
  },
  {
    ...
    interactiveProps: { rotationSpeed: 0.7, wireframe: false, glowColor: '#f59e0b' }
  },
  {
    id: 'art-ashanti-1',
    civId: 'ashanti',
...
export default function Artifact3DGallery({ initialCivId = null, onClose = null }) {
  ...
  return (
    <div className="w-full min-h-[600px] rounded-3xl border overflow-hidden flex flex-col relative font-sans transition-all duration-500 shadow-2xl bg-[#050609] border-amber-500/20 text-zinc-100 shadow-black/90">
      ...
      <div className="px-6 py-4 border-b flex flex-col md:flex-row md:items-center justify-between gap-4 z-20 backdrop-blur-md border-white/10 bg-zinc-950/80">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-sm font-bold font-mono uppercase tracking-wider flex items-center gap-2">
              ...
              <span className="text-[10px] px-2 py-0.5 rounded-full border bg-amber-500/10 border-amber-500/30 text-amber-400 font-mono">
                WALKTHROUGH
              </span>
            </h2>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <select
            ...
            className="px-3 py-1.5 rounded-xl text-xs font-mono outline-none border transition-all bg-zinc-900 border-white/10 text-zinc-200 focus:border-amber-500"
          >
          ...
          {onClose && (
            <button
              onClick={onClose}
              className="px-3 py-1.5 rounded-xl text-xs font-mono bg-amber-500/20 text-amber-400 hover:bg-amber-500/30 transition-colors"
            >
              Exit Exhibition
            </button>
          )}
      ...
      <div className="flex-1 relative min-h-[460px] flex items-center justify-center overflow-hidden">
        ...
        <div
          ...
          style={{ backgroundColor: currentArtifact.interactiveProps.glowColor || '#f59e0b' }}
        />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center p-6 text-center">
          ...
          <div className="relative w-64 h-64 md:w-80 md:h-80 flex items-center justify-center group">
            ...
            <div className="absolute bottom-2 w-56 h-12 rounded-[100%] border border-amber-500/30 bg-amber-500/5 blur-[2px] animate-pulse" />
            <div className="absolute bottom-4 w-40 h-8 rounded-[100%] border border-amber-400/40 bg-amber-400/10" />
            ...
            <div
              className={`relative w-48 h-48 md:w-60 md:h-60 rounded-2xl overflow-hidden shadow-2xl border transition-all duration-300 ${
                wireframeMode ? 'border-cyan-400/80 shadow-cyan-500/20 bg-cyan-950/20' : 'border-amber-500/40 shadow-amber-500/20'
              }`}
              style={{
            ...
            <div className="absolute inset-0 pointer-events-none animate-spin-slow">
              <div className="w-2 h-2 rounded-full bg-amber-400 shadow-[0_0_10px_#f59e0b] absolute top-2 left-1/2" />
              <div className="w-1.5 h-1.5 rounded-full bg-amber-200 shadow-[0_0_8px_#fde047] absolute bottom-4 right-10" />
            </div>
          </div>
        ...
        <button
          onClick={handlePrev}
          className="absolute left-4 top-1/2 -translate-y-1/2 p-3 rounded-2xl border shadow-2xl z-30 transition-all hover:scale-110 bg-zinc-900/90 hover:bg-zinc-800 border-amber-500/30 text-amber-400"
        ...
        <button
          onClick={handleNext}
          className="absolute right-4 top-1/2 -translate-y-1/2 p-3 rounded-2xl border shadow-2xl z-30 transition-all hover:scale-110 bg-zinc-900/90 hover:bg-zinc-800 border-amber-500/30 text-amber-400"
          title="Next Artifact"
        >
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
            <div className="space-y-2 md:col-span-2">
              <div className="flex items-center gap-2 flex-wrap">
                <span className="text-xs font-mono font-bold px-2.5 py-0.5 rounded-full bg-amber-500/20 border border-amber-500/30 text-amber-400">
                  {currentArtifact.era}
                </span>
