...
// Initial dataset for Pan-African Civilization Knowledge Graph
const GRAPH_NODES = [
...
export default function OracleKnowledgeGraph({ onSelectNode }) {
    ...
    node
      .on('mouseenter', (event, d) => {
        ...
        link
          ...
          .attr('stroke', (l) => (l.source.id === d.id || l.target.id === d.id ? '#F59E0B' : '#52525B'));
      })
      .on('mouseleave', () => {
        setHoveredNode(null);
        link
