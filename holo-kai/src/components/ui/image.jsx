...
const FALLBACK_IMAGE_URL =
  "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='800' height='600' viewBox='0 0 800 600'><rect width='800' height='600' fill='%23090d16'/><circle cx='400' cy='280' r='70' fill='none' stroke='%23f59e0b' stroke-width='1.5' stroke-dasharray='4 4'/><polygon points='400,230 440,310 360,310' fill='none' stroke='%23f59e0b' stroke-width='2'/><text x='400' y='380' text-anchor='middle' fill='%23fbbf24' font-family='monospace' font-size='15' font-weight='bold'>HOLOKAI GUARDIAN ARCHIVE</text><text x='400' y='405' text-anchor='middle' fill='%2371717a' font-family='monospace' font-size='12'>CIVILIZATION RECONSTRUCTION</text></svg>"
