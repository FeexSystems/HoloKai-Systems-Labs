...
function OracleSkeletonLoader() {
  return (
    <div className="space-y-6 animate-pulse">
      <div className="glass-panel p-5 rounded-xl border border-[var(--color-border)] bg-zinc-950/80 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="space-y-2 w-full md:w-2/3">
          <div className="h-4 bg-[var(--color-surface-hover)] rounded w-1/3" />
          <div className="h-6 bg-[var(--color-surface-hover)] rounded w-2/3" />
        </div>
        <div className="flex gap-2 w-full md:w-auto">
          <div className="h-9 bg-[var(--color-surface-hover)] rounded-lg w-24" />
          <div className="h-9 bg-[var(--color-surface-hover)] rounded-lg w-28" />
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="glass-panel p-5 rounded-xl border border-[var(--color-border)] bg-zinc-950/80 space-y-3">
            <div className="flex items-center justify-between">
              <div className="h-3 bg-[var(--color-surface-hover)] rounded w-24" />
              <div className="w-6 h-6 rounded bg-[var(--color-surface-hover)]" />
            </div>
            <div className="h-8 bg-[var(--color-surface-hover)] rounded w-1/2" />
            <div className="h-2.5 bg-[var(--color-brand)]/15 rounded w-full" />
          </div>
        ))}
      </div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 glass-panel p-6 rounded-xl border border-[var(--color-border)] bg-zinc-950/80 h-72 flex flex-col justify-between">
          <div className="h-4 bg-[var(--color-brand)]/25 rounded w-48" />
          <div className="h-44 bg-[var(--color-surface-hover)] rounded-lg w-full flex items-end p-4 gap-3">
            {[40, 70, 85, 50, 95, 65, 80].map((h, idx) => (
              <div key={idx} className="flex-1 bg-[var(--color-surface-hover)] rounded-t" style={{ height: `${h}%` }} />
            ))}
          </div>
        </div>
        <div className="glass-panel p-6 rounded-xl border border-[var(--color-border)] bg-zinc-950/80 h-72 space-y-3">
          <div className="h-4 bg-[var(--color-brand)]/25 rounded w-36" />
          {[1, 2, 3].map((j) => (
            <div key={j} className="flex items-center gap-3 p-2 bg-[var(--color-surface-hover)] rounded-lg">
              <div className="w-8 h-8 rounded-full bg-[var(--color-surface-hover)] shrink-0" />
              <div className="space-y-1.5 flex-1">
                <div className="h-3 bg-[var(--color-surface-hover)] rounded w-3/4" />
                <div className="h-2 bg-[var(--color-brand)]/15 rounded w-1/2" />
              </div>
            </div>
          ))}
        </div>
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#0a0a0f]/80 backdrop-blur-md border border-white/5 p-4 rounded-xl">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-[var(--color-surface-hover)] border border-[var(--color-border)] flex items-center justify-center text-[var(--color-brand)]">
          ...
          <div>
            <h2 className="text-base font-display font-semibold text-white tracking-wide flex items-center gap-2">
              ...
              <span className="text-[10px] font-mono uppercase bg-[var(--color-surface-hover)] text-[var(--color-brand)] border border-[var(--color-border)] px-2 py-0.5 rounded">
                LIVE METRICS
              </span>
            </h2>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <div className="relative flex items-center">
            <Filter className="w-3.5 h-3.5 text-[var(--color-brand)]/70 absolute left-2.5 pointer-events-none" />
            <select
              ...
              className="pl-8 pr-4 py-1.5 bg-zinc-900/90 border border-[var(--color-border)] text-xs font-mono text-zinc-200 rounded-lg focus:outline-none focus:border-[var(--color-border)] cursor-pointer"
            >
              {CIVILIZATIONS.map((c) => (
          ...
          <button
            ...
            onMouseEnter={() => retroAudio.playGlassHoverHum()}
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[var(--color-surface-hover)] hover:bg-[var(--color-surface-hover)] border border-[var(--color-border)] text-[var(--color-brand)] text-xs font-mono transition-all disabled:opacity-50"
          >
          ...
          <button
            ...
            onMouseEnter={() => retroAudio.playGlassHoverHum()}
            className="border border-[var(--color-border)] text-[var(--color-brand)] hover:text-white text-xs font-mono px-3.5 py-1.5 rounded-lg flex items-center gap-1.5 hover:bg-[var(--color-surface-hover)] transition-all cursor-pointer bg-transparent"
            title="Download CSV dataset of historical metrics"
          >
            <Download className="w-3.5 h-3.5 text-[var(--color-brand)]" />
          ...
          <button
            ...
            onMouseEnter={() => retroAudio.playGlassHoverHum()}
            className="shadow-[0_0_15px_rgba(232,184,75,0.25)] hover:shadow-[0_0_25px_rgba(232,184,75,0.45)] border border-[var(--color-border)] text-[var(--color-brand)] hover:text-white text-xs font-mono px-3.5 py-1.5 rounded-lg flex items-center gap-1.5 hover:bg-[var(--color-surface-hover)] transition-all cursor-pointer bg-transparent"
      ...
      {isRefreshing ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              <div className="absolute top-0 right-0 w-24 h-24 bg-[var(--color-brand)]/5 rounded-full blur-2xl group-hover:bg-[var(--color-brand)]/15 transition-all" />
              <div>
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-display font-bold text-transparent bg-clip-text bg-gradient-to-r from-[var(--pui-forest-active)] via-[var(--pui-teal-bright)] to-yellow-500">
                    {displayPrecision}%
                  </span>
              ...
              <div className="mt-4 pt-3 border-t border-white/5 text-[11px] text-zinc-400 flex justify-between items-center">
                ...
                <span className="text-[var(--color-brand)] font-mono text-[10px]">VERIFIED</span>
              </div>
            </div>
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between text-zinc-400 text-xs font-mono uppercase tracking-wider mb-2">
                  ...
                  <ScrollText className="w-4 h-4 text-[var(--color-brand)]" />
                </div>
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-display font-bold text-white">
                    {displayManuscripts.toLocaleString()}
                  </span>
                  <span className="text-[10px] text-[var(--color-brand)] font-mono">Cataloged</span>
                </div>
              </div>
              <div className="mt-4 pt-3 border-t border-white/5 text-[11px] text-zinc-400 flex justify-between items-center">
                <span>Timbuktu, Ge'ez, Arabic, Ajami</span>
                <span className="text-[var(--color-brand)] font-mono text-[10px]">DIGITIZED</span>
              </div>
            </div>
            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between text-zinc-400 text-xs font-mono uppercase tracking-wider mb-2">
                  ...
                  <Volume2 className="w-4 h-4 text-[var(--color-brand)]" />
                </div>
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-display font-bold text-white">
              ...
              <div className="mt-4 pt-3 border-t border-white/5 text-[11px] text-zinc-400 flex justify-between items-center">
                ...
                <span className="text-[var(--color-brand)] font-mono text-[10px]">INDEXED</span>
              </div>
            </div>
            ...
            >
              ...
              <div className="mt-4 pt-3 border-t border-white/5 text-[11px] text-zinc-400 flex justify-between items-center">
                ...
                <span className="text-[var(--color-brand)] font-mono text-[10px]">MAPPED</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-[#0a0a0f]/80 border border-white/5 p-5 rounded-xl space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10px] font-mono text-[var(--color-brand)] bg-[var(--color-surface-hover)] border border-[var(--color-border)] px-2.5 py-1 rounded">
                  ...
                  <AreaChart data={HISTORICAL_ACTIVITY_DATA} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
                    <defs>
                      <linearGradient id="kemetColor" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="5%" stopColor="#39826F" stopOpacity={0.45} />
                        <stop offset="95%" stopColor="#39826F" stopOpacity={0} />
                      </linearGradient>
                      <linearGradient id="maliColor" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="5%" stopColor="#A9D5B0" stopOpacity={0.35} />
                        <stop offset="95%" stopColor="#A9D5B0" stopOpacity={0} />
                      </linearGradient>
                    </defs>
                    ...
                    />
                    <Area type="monotone" dataKey="kemet" name="Nile & Sahel Volume" stroke="#39826F" strokeWidth={2} fillOpacity={1} fill="url(#kemetColor)" />
                    <Area type="monotone" dataKey="mali" name="West Africa Codices" stroke="#A9D5B0" strokeWidth={2} fillOpacity={1} fill="url(#maliColor)" />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </div>
                ...
                <div className="h-44 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                      ...
                      />
                      <Bar dataKey="val" name="Cataloged Scale" fill="#39826F" radius={[4, 4, 0, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              </div>

              <div className="p-3 bg-[var(--color-surface-hover)] border border-[var(--color-border)] rounded-lg text-[11px] text-[var(--color-brand)]/90 flex items-center justify-between">
                <span>Guaranteed Zero-Hallucination Policy</span>
                <Award className="w-4 h-4 text-[var(--color-brand)] shrink-0" />
              </div>
            </div>
          </div>
                ...
                return (
                  <div
                    ...
                    className={`bg-[#0a0a0f]/80 border p-5 rounded-xl transition-all duration-300 relative group cursor-pointer ${
                      isExpanded
                        ? 'border-[var(--color-border)] shadow-[0_0_25px_rgba(232,184,75,0.35)] scale-[1.01]'
                        : 'border-white/5 hover:border-[var(--color-border)]'
                    }`}
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-[10px] font-mono uppercase bg-[var(--color-brand)]/15 text-[var(--color-brand)] border border-[var(--color-border)] px-2 py-0.5 rounded">
                            {entry.tag}
                          </span>
                        ...
                        <h4 className="text-sm font-display font-bold text-white group-hover:text-[var(--color-brand)] transition-colors">
                          {entry.title}
                        </h4>
                      </div>
                      ...
                      <button
                        ...
                        className={`p-2 rounded-lg border transition-all shrink-0 ${
                          isNarrating
                            ? 'bg-[var(--color-surface-hover)] border-[var(--color-border)] text-[var(--color-brand)] animate-pulse'
                    ...
                    {isExpanded && (
                      <div className="mt-4 pt-3 border-t border-[var(--color-border)] space-y-2 animate-[fadeIn_0.3s_ease-out]">
                        <p className="text-xs text-zinc-400 leading-relaxed font-body italic">
                          "{entry.fullDescription}"
                        </p>
                        <div className="flex items-center justify-between text-[10px] font-mono text-[var(--color-brand)] pt-1">
