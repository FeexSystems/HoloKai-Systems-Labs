...
export const visionPillars: readonly VisionPillar[] = [
  {
    id: "sovereignty",
...
export const visionLanguages: readonly string[] = [
  "Yoruba",
  "Igbo",
  "Hausa",
  "Swahili",
...
export const anatomySystems: readonly AnatomySystem[] = [
  {
    id: "sensory",
...
export const anatomyStats: readonly AnatomyStat[] = [
...
export const intelligenceAgents: readonly IntelligenceAgent[] = [
  {
    id: "archaeologist",
...
export const intelligencePipeline: readonly IntelligencePipelineStep[] = [
